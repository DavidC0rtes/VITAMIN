...
setup( 
    ...
    packages=[
        ...
        'vitamin_model_checker.logics.LTL',
        'vitamin_model_checker.logics.NATSL',
        ...
        'vitamin_model_checker.model_checker_interface.explicit.LTL',
        'vitamin_model_checker.model_checker_interface.explicit.NatATL',
        'vitamin_model_checker.model_checker_interface.explicit.NatATLF',
        ...
        'vitamin_model_checker.model_checker_interface.explicit.SolutionConcepts',
