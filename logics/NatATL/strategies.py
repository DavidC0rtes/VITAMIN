...
import itertools
import random
from utilities.read_input import get_actions, get_graph, get_number_of_agents, get_atomic_prop, read_file
import os
from utilities.parser.NatATL.NatATLtoCTL import get_agents_from_natatl, natatl_to_ctl, get_k_value
from utilities.parser.NatATL.stringParser import parse_string
...
def initialize(model_path, formula):
    ...
    matrixParser(graph, get_number_of_agents())
    ...
    atomic_propositions = get_atomic_prop()
